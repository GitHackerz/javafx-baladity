...
public class EditAssociationController {
    ...
    @FXML
    private MFXButton edit_association_btn;
    ...
    public void setSelectedAssociation(Association selectedAssociation) {
        this.selectedAssociation = selectedAssociation;
        nom_association.setText(selectedAssociation.getNom());
        adresse_association.setText(selectedAssociation.getAdresse());
        type_association.setText(selectedAssociation.getType());
        caisse_association.setText(String.valueOf(selectedAssociation.getCaisse()));
        statut_association.setSelected(selectedAssociation.getStatus().equals("active"));
    }

    @FXML
    void editAssociation(ActionEvent event) {
        resetErrors();
        ...
        Association association = new Association(selectedAssociation.getId(), nom, adresse, type, Float.parseFloat(caisse_association.getText()), statut_association.isSelected() ? "active" : "inactive");
